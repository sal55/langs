...
global function c2o(ref int32 c)int64 =
    return int32(c)+1
end

global function cp(int32 o)int64 =
    return o iand 3=1
end
...
global function a2o(ref int32 a)int64 =
    return int32(a)+2
end

global function ap(int32 o)int64 =
    return o iand 3=2
end
...
global function s2o(ref int32 s)int64 =
    return int32(s)+3
end

global function sp(int32 o)int64 =
    return o iand 3=3
end

global function car(int32 c)int64 =
    return (c iand 3=1|o2c(c)[0]|0)
end

global function cdr(int32 c)int64 =
    return (c iand 3=1|o2c(c)[1]|0)
end

global function caar(int32 c)int64 =
    return car(car(c))
end

global function lread(ref int32 g)int64 =
    int32 c
    real64 d
...
global function cdar(int32 c)int64 =
    return cdr(car(c))
end

global function evca(ref int32 f, int32 co)int64 =
    int32 ex
    int32 x
    int32 m
    int32 fn
...
global function cadr(int32 c)int64 =
    return car(cdr(c))
end

global function dbgr(ref int32 f, int32 x, val, ref int32 vp)int64 =
    int32 ex
    int32 i
    ref int32 h
    int32 l
...
global function cddr(int32 c)int64 =
    return cdr(cdr(c))
end
...
global function set_car(int32 c, val)int64 =
    return o2c(c)[0] := val
end

global function set_cdr(int32 c, val)int64 =
    return o2c(c)[1] := val
end
...
global function gc(ref int32 f)int64 =
    int32 i
    ref int32 m
    int32 l
    int32 u
...
global function ma(ref int32 g, int32 n, ...)int64 =
    ref byte v
    int32 i
    ref int32 m
...
global function ms(ref int32 g, int32 n, ...)int64 =
    ref byte v
    int32 i
    ref int32 m
...
global function d2o(ref int32 g, real64 d)int64 =
    int32 x
    ref int32 a
...
global function o2i(int32 o)int64 =
    return int32(o2d(o))
end

global function o2u(int32 o)word64 =
    return word32(o2d(o))
end

global function cons(ref int32 g, int32 a, d)int64 =
    ref int32 c
...
global function string_equal_do(int32 a, b)int64 =
    int32 i
...
global function rest(ref int32 h, g)int64 =
    ref int32 f
    int32 r
...
global function args(ref int32 f, int32 m, c)int64 =
    ref int32 g
    ref int32 h
    int32 t
    int32 k
...
global function argd(ref int32 f, int32 n, a)int64 =
    ref int32 h
...
global function eval_body(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function map_eval(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval(ref int32 f, int32 expr)int64 =
    ref int32 g
...
global function rvalues(ref int32 g, int32 v)int64 =
    return (xvalues=8|cons(g,v,0)|xvalues)
end

global function mvalues(int32 a)int64 =
    xvalues := a
    return car(a)
end

global function infn(ref int32 f, h)int64 =
    [128]int32 jmp
    int32 vs
    ref int32 g
    int32 fn
...
global function call(ref int32 f, int32 fn, word32 d)int64 =
    ref int32 g
...
global function eval_quote(ref int32 g, int32 ex)int64 =
    return car(ex)
end

global function specp(ref int32 f, int32 ex, s)int64 =
    int32 e
    int32 sp
...
global function eval_let(ref int32 f, int32 ex)int64 =
    int32 r
    ref int32 g
...
global function eval_letm(ref int32 f, int32 ex)int64 =
    int32 r
    ref int32 g
...
global function eval_progv(ref int32 f, int32 ex)int64 =
    int32 r
    ref int32 g
...
global function eval_flet(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_labels(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_macrolet(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_symbol_macrolet(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_setq(ref int32 f, int32 ex)int64 =
    int32 r
...
global function eval_function(ref int32 f, int32 ex)int64 =
    int32 x
    int32 n
...
global function eval_tagbody(ref int32 f, int32 ex)int64 =
    [128]int32 jmp
    int32 tag
    int32 e
    ref int32 g
...
global function eval_go(ref int32 f, int32 ex)int64 =
    int32 b
...
global function eval_block(ref int32 f, int32 ex)int64 =
    [128]int32 jmp
    int32 vs
    ref int32 g
...
global function eval_return_from(ref int32 f, int32 ex)int64 =
    int32 b
    ref [128]int32 jmp
    ref int32 g
...
global function eval_catch(ref int32 f, int32 ex)int64 =
    [128]int32 jmp
    int32 vs
    int32 oc
    ref int32 g
...
global function eval_throw(ref int32 f, int32 ex)int64 =
    int32 c
    ref int32 g
...
global function eval_unwind_protect(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_if(ref int32 f, int32 ex)int64 =
    return evca(f,(evca(f,ex)|cdr(ex)|cddr(ex)))
end

global function eval_multiple_value_call(ref int32 f, int32 ex)int64 =
    ref int32 g
    int32 l
...
global function eval_multiple_value_prog1(ref int32 f, int32 ex)int64 =
    ref int32 g
...
global function eval_declare(ref int32 f, int32 ex)int64 =
    return 0
end

global function l2(ref int32 f, int32 a, b)int64 =
    return cons(f,a,cons(f,b,0))
end

global function eval_setf(ref int32 f, int32 ex)int64 =
    int32 r
    int32 m
    ref int32 g
...
global function llist(ref int32 f, h)int64 =
    return rest(h,f+1)
end

global function lvalues(ref int32 f, h)int64 =
    return mvalues(rest(h,f+1))
end

global function lfuncall(ref int32 f, h)int64 =
    return call(f,f[1],h-f-2)
end

global function lapply(ref int32 f, h)int64 =
    while h[-1] do
        h[0] := cdr(h[-1])
        h[-1] := car(h[-1])
        h++
...
global function leq(ref int32 f)int64 =
    return (f[1]=f[2]|symi[1].sym|0)
end

global function lcons(ref int32 f)int64 =
    return cons(f,f[1],f[2])
end

global function lcar(ref int32 f)int64 =
    return car(f[1])
end

global function setfcar(ref int32 f)int64 =
    return set_car(f[2],f[1])
end

global function lcdr(ref int32 f)int64 =
    return cdr(f[1])
end

global function setfcdr(ref int32 f)int64 =
    return set_cdr(f[2],f[1])
end

global function lequ(ref int32 f, h)int64 =
    real64 s
...
global function lless(ref int32 f, h)int64 =
    real64 s
...
global function lplus(ref int32 f, h)int64 =
    real64 s
...
global function lminus(ref int32 f, h)int64 =
    real64 s
...
global function ltimes(ref int32 f, h)int64 =
    real64 s
...
global function ldivi(ref int32 f, h)int64 =
    real64 s
...
global function ldpb(ref int32 f)int64 =
    int32 s
    int32 p
    int32 m
...
global function lldb(ref int32 f)int64 =
    int32 s
    int32 p
...
global function lfloor(ref int32 f, h)int64 =
    real64 n
    real64 d
    real64 q
...
global function lgensym(ref int32 f)int64 =
    ref int32 r
...
global function lcode_char(ref int32 f)int64 =
    word32 c
...
global function lchar_code(ref int32 f)int64 =
    return f[1] iand inot 8
end

global function lmakef(ref int32 f)int64 =
    return d2o(f,f-stack)
end

global function lfref(ref int32 f)int64 =
    return stack[o2i(f[1])]
end

global function stringify(ref int32 f, int32 l)int64 =
    int32 i
    ref int32 r
    int32 t
...
global function lstring(ref int32 f, h)int64 =
    return stringify(f,rest(h,f+1))
end

global function lival(ref int32 f)int64 =
    return d2o(f,f[1])
end

global function lmakei(ref int32 f, h)int64 =
    int32 i
    int32 l
    ref int32 r
...
global function liboundp(ref int32 f)int64 =
    return (o2a(f[1])[o2u(f[2])]=8|0|symi[1].sym)
end

global function limakunbound(ref int32 f)int64 =
    o2a(f[1])[o2u(f[2])] := 8
    return 0
end

global function liref(ref int32 f)int64 =
...
global function setfiref(ref int32 f)int64 =
    int32 i
...
global function lmakej(ref int32 f)int64 =
    ref int32 r
...
global function ljref(ref int32 f)int64 =
    return d2o(f,o2s(f[1])[o2u(f[2])])
end

global function setfjref(ref int32 f)int64 =
    return o2s(f[2])[o2u(f[3])] := o2u(f[1])
end

global function lmake_fs(ref int32 f)int64 =
    ref void fd

    fd := CreateFileA(o2z(f[1]),(f[2]|1073741824|2147483648),(f[2]|2|1),ref void(0),3,128,ref void(0))
    return ms(f,4,116,1,fd,f[2],0)
end

global function lclose_fs(ref int32 f)int64 =
    CloseHandle(o2s(f[1])[3])
    return 0
end

global function llisten_fs(ref int32 f)int64 =
    return (WaitForSingleObject(o2s(f[1])[3],0)=0|symi[1].sym|0)
end

global function lread_fs(ref int32 f)int64 =
    int32 l

    l := o2i(f[3])
    if not ReadFile(o2s(f[1])[3],o2z(f[2])+l,o2s(f[2])[0]>>6-4-l,&l,ref void(0)) then
        return 0
    fi
    return d2o(f,l)
end

global function lwrite_fs(ref int32 f)int64 =
    int32 l

    l := o2i(f[3])
    if not WriteFile(o2s(f[1])[3],o2z(f[2])+l,o2i(f[4])-l,&l,ref void(0)) then
        return 0
    fi
    return d2o(f,l)
end

global function lfinish_fs(ref int32 f)int64 =
    FlushFileBuffers(o2s(f[1])[3])
    return 0
end

global function lfasl(ref int32 f)int64 =
    ref void h
...
global function luname(ref int32 f)int64 =
    OSVERSIONINFO osvi
...
global function lload(ref int32 f)int64 =
    load(f,o2z(f[1]))
    return symi[1].sym
end

global function lstring_equal(ref int32 f)int64 =
    return (string_equal(f[1],f[2])|symi[1].sym|0)
end

global function leval(ref int32 f, h)int64 =
    f[-1] := (h-f>2|f[2]|0)
    return eval(f-1,f[1])
end
...
global function lprint(ref int32 f)int64 =
    print(f[1])
    return f[1]
end

global function ep(ref int32 g, int32 expr)int64 =
    int32 i
    int32 v
...
global function read_list(ref int32 f)int64 =
    int32 c
    ref int32 g
    int32 r
...
global function read_string_list(ref int32 g)int64 =
    int32 c
...
global function hash(int32 s)word64 =
    ref byte z
    word32 i
    word32 h
    word32 g
...
global function lhash(ref int32 f)int64 =
    return d2o(f,hash(f[1]))
end

global function is(ref int32 g, int32 p, s)int64 =
    int32 h
    int32 i
    int32 m
    int32 y
...
global function read_symbol(ref int32 g)int64 =
    int32 c
...
global function list2(ref int32 g, int32 a)int64 =
    return l2(g,symi[a].sym,lread(g))
end

global function strf(ref int32 f, ref byte s)int64 =
    int32 j
    ref int32 str
...
global function mkv(ref int32 f)int64 =
    int32 i
    ref int32 r
...
global function mkp(ref int32 f, ref byte s0, s1)int64 =
    return ma(f,6,180,l2(f,strf(f,s0),strf(f,s1)),mkv(f),mkv(f),0,0,0)
end

global function fr(ref int32 o, p, s, c, b, int32 x)int64 =
    int32 t
...
global function fasr(ref int32 f, p, int32 pz, ref int32 s, sp, int32 sz, ref int32 c, int32 cz, ref int32 v, int32 vz, ref int32 o, int32 oz, ref ref int32 rv, ro)int64 =
    ref int32 x
    ref int32 y
    int32 i
    int32 l
...
global function lrp(ref int32 f, h)int64 =
    STARTUPINFO si
    ...
    pi := (0)
    si.cb := 104
    if CreateProcessA(o2z(f[1]),o2z(f[2]),ref void(0),ref void(0),0,0,ref void(0),ref void(0),&si,&pi) then
        return symi[1].sym
    fi
    return 0
end

global function cmain(int32 argc, ref ref byte argv)int64 =
    ref int32 g
    int32 i
    int32 sym
...
proc main=
	stop cmain(ncmdparams,&cmdparams)
end
