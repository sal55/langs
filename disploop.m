...
!       jumptable:=nil          # set this when not using doswitchx
        return
    fi

    sp:=sptr                    # sptr etc are global variable versions
    pc:=pcptr
    fp:=frameptr

!Fastest dispatch (needs external code to fixup up opcode index to direct labels)
