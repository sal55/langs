// PCI.C
// Build on Windows using any of:
//
//   gcc pci.c -opci.exe
//   gcc -O3 pci.c -opci.exe
//   tcc pci.c -fdollars-in-identifiers -luser32 c:\windows\system32\kernel32.dll
//
// Run using
//   pci file                     # to execute file.pci
...
void pci_lib$showst(void *f);
static void pci_lib$showstrec(struct pci_decls$strec *d,void *f);
void pci_lib$showdiags(void);
static u8 *pci_lib$getbasename(u8 *s);
static void pci_lib$showlibs(void *f);
void pci_lib$showpcl(void *f,i64 pass);
static void pci_lib$writepcl(struct pci_decls$pclrec *p,void *f,i64 pass);
void pci_lib$start(void);
...
static u8 *  msysc$_fnnames[]= {
    ...
    (byte*)"start",
(byte*)""};
static i64 msysc$_fnnprocs=278;
...
L46 :;
    ...
    pci_lex$adddlllib((byte*)"msvcrt");
    pci_lex$adddlllib((byte*)"gdi32");
    pci_lex$adddlllib((byte*)"user32");
    pci_lex$adddlllib((byte*)"kernel32");
}
...
void pci_lib$showst(void *f) {
    ...
    msysc$m_print_str((byte*)"Symbol Table:",NULL);
    msysc$m_print_newline();
    msysc$m_print_end();
    ;
    for (i=(i64)0;i<=(i64)65535;++i) {
L54 :;
        d = (struct pci_decls$strec *)&pci_decls$hashtable[(i)];
        if ((!!((i64)(*d).namelen) && ((i64)(*d).opcode==(i64)(*d).typecode && (i64)(*d).typecode==(i64)0))) {
            pci_lib$showstrec(d,f);
        }
;
L55 :;
    }
...
static void pci_lib$showstrec(struct pci_decls$strec *d,void *f) {
    ...
    msysc$m_print_str((byte*)":",NULL);
    msysc$m_print_str((*d).name,(byte*)"28jl");
    msysc$m_print_end();
    ;
    msysc$m_print_startfile(f);
    msysc$m_print_str(pci_tables$idtypenames[((i64)(*d).idtype)],(byte*)"10jl");
    msysc$m_print_end();
    ;
    if (((i64)(*d).mode == (i64)5)) {
        msysc$m_print_startfile(f);
        msysc$m_print_setfmt((byte*)"mem:#");
        msysc$m_print_i64((i64)(*d).memsize,(byte*)"8jl");
        msysc$m_print_end();
        ;
    }
    else {
        msysc$m_print_startfile(f);
        msysc$m_print_str(pci_tables$typenames[((i64)(*d).mode)],(byte*)"6jl");
        msysc$m_print_i64((i64)(*d).memsize,NULL);
        msysc$m_print_space();
        msysc$m_print_end();
        ;
    }
;
        ($av_1 = (i64)(*d).nretvalues);
    for (i=(i64)2;i<=$av_1;++i) {
L57 :;
        msysc$m_print_startfile(f);
        msysc$m_print_str(pci_tables$typenames[((i64)(*d).retmode[(i)-1])],(byte*)"6jl");
        msysc$m_print_end();
        ;
L58 :;
    }
L59 :;
    ;
    if (!!(msysc$m_getdotindex((i64)(*d).flags,(i64)0))) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Import ",NULL);
        msysc$m_print_end();
        ;
    }
;
    if (!!(msysc$m_getdotindex((i64)(*d).flags,(i64)1))) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Export ",NULL);
        msysc$m_print_end();
        ;
    }
;
...
if (($temp==(i64)1)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"PCindex:",NULL);
        msysc$m_print_i64((*d).pcindex,NULL);
        msysc$m_print_str((byte*)"Params:",NULL);
        msysc$m_print_i64((i64)(*d).nparams,NULL);
        msysc$m_print_str((byte*)"Locals:",NULL);
        msysc$m_print_i64((i64)(*d).nlocals,NULL);
        msysc$m_print_str((byte*)"Nretvals:",NULL);
        msysc$m_print_i64((i64)(*d).nretvalues,NULL);
        msysc$m_print_str((byte*)"Entry:",NULL);
        msysc$m_print_i64((*d).pcindex,NULL);
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)4) || ($temp==(i64)3)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Offset:",NULL);
        msysc$m_print_i64((*d).frameoffset,NULL);
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)2)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Addr:",NULL);
        msysc$m_print_ptr((*d).staticaddr,NULL);
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)5)) {
        msysc$m_print_startfile(f);
        msysc$m_print_i64((*d).importno,NULL);
        msysc$m_print_end();
        ;
    }
    };
...
void pci_lib$showdiags(void) {
        u8 str[100];
        void *  f;
    f = fopen((byte*)"pci.log",(byte*)"w");
    if (((i64)$pci$passlevel == (i64)3)) {
        return;
    }
;
    if (!(((!!((i64)$pci$fshowpcl) || !!((i64)$pci$fshowst)) || !!((i64)$pci$fshowlibs)))) {
        return;
    }
;
    if ((!!((i64)$pci$fshowpcl) && ((i64)$pci$passlevel >= (i64)1))) {
        pci_lib$showpcl(f,(((i64)$pci$passlevel == (i64)2) ? (i64)2 : (i64)1));
    }
;
    if (!!((i64)$pci$fshowst)) {
        pci_lib$showst(f);
...
;
    if (!!((i64)$pci$fshowlibs)) {
        pci_lib$showlibs(f);
    }
;
    fclose(f);
    msysc$m_print_startstr(str);
    msysc$m_print_str((byte*)"c:\\m\\ed.bat -w pci.log",NULL);
    msysc$m_print_end();
    ;
    mwindows$os_execwait(str,(i64)1,0);
}
...
static void pci_lib$showlibs(void *f) {
    ...
    msysc$m_print_i64(pci_decls$nlibs,NULL);
    msysc$m_print_newline();
    msysc$m_print_end();
    ;
...
L63 :;
        ...
        msysc$m_print_str((byte*)"\t",NULL);
        msysc$m_print_i64(i,NULL);
        msysc$m_print_str(pci_decls$libnames[(i)-1],NULL);
        msysc$m_print_newline();
        msysc$m_print_end();
        ;
L64 :;
...
L65 :;
    ...
    ;
    msysc$m_print_startfile(f);
    msysc$m_print_str((byte*)"Ext Procs",NULL);
    msysc$m_print_i64(pci_decls$nextprocs,NULL);
    msysc$m_print_newline();
    msysc$m_print_end();
    ;
    for (i=(i64)1;i<=pci_decls$nextprocs;++i) {
L66 :;
        d = pci_decls$extdef[(i)-1];
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"\t",NULL);
        msysc$m_print_i64(i,NULL);
        msysc$m_print_str((*d).name,NULL);
        ...
        msysc$m_print_end();
        ;
                ($av_1 = (i64)pci_decls$extnparams[(i)-1]);
        for (k=(i64)1;k<=$av_1;++k) {
L69 :;
            msysc$m_print_startfile(f);
            msysc$m_print_str(pci_tables$typenames[((i64)pci_decls$exttypes[(i)-1][(k)-1])],NULL);
            msysc$m_print_space();
            msysc$m_print_end();
            ;
L70 :;
...
L71 :;
        ;
        if (!!((i64)pci_decls$extvariadic[(i)-1])) {
            msysc$m_print_startfile(f);
            msysc$m_print_str((byte*)" ...",NULL);
            msysc$m_print_end();
            ;
...
;
        ...
        if (!!((i64)(*d).mode)) {
            ...
            msysc$m_print_str((byte*)"->",NULL);
            msysc$m_print_nogap();
            msysc$m_print_str(pci_tables$typenames[((i64)pci_decls$extrettype[(i)-1])],NULL);
            msysc$m_print_end();
            ;
            if (((i64)(*d).mode == (i64)5)) {
                msysc$m_print_startfile(f);
...
void pci_lib$showpcl(void *f,i64 pass) {
        u8 str[32];
        struct pci_decls$pclrec *  p;
        static i64 procseen = (i64)0;
        i64 i;
        i64 k;
    msysc$m_print_startfile(f);
    msysc$m_print_str((byte*)"PCL",NULL);
    msysc$m_print_i64(pass,NULL);
    msysc$m_print_newline();
    msysc$m_print_end();
    ;
    for (i=(i64)1;i<=pci_decls$npcl;++i) {
L72 :;
        for (k=(i64)1;k<=(i64)8;++k) {
L75 :;
            if (!!((i64)(*pci_decls$pcllabels)[(i)-1][(k)-1])) {
                msysc$m_print_startfile(f);
                msysc$m_print_setfmt((byte*)"            ##:");
                msysc$m_print_str((byte*)"#",NULL);
                msysc$m_print_i64((i64)(*pci_decls$pcllabels)[(i)-1][(k)-1],NULL);
                msysc$m_print_newline();
                msysc$m_print_end();
                ;
            }
...
L77 :;
        ;
        p = (struct pci_decls$pclrec *)&(*pci_decls$pcltable)[(i)-1];
...
;
        msysc$m_print_startfile(f);
        msysc$m_print_setfmt((byte*)"#:#: ");
        msysc$m_print_i64((i64)(*pci_decls$pcllines)[(i)-1],(byte*)"5");
        msysc$m_print_i64(i,(byte*)"Z5");
        msysc$m_print_end();
        ;
        pci_lib$writepcl((struct pci_decls$pclrec *)p,f,pass);
L73 :;
    }
L74 :;
    ;
...
;
    msysc$m_print_startfile(f);
    msysc$m_print_str((pci_tables$pclnames[(opcode)-1] + (i64)1),(byte*)"10jl");
    msysc$m_print_end();
    ;
    if ((opcode == (i64)1)) {
        msysc$m_print_startfile(f);
...
;
    if ((pass == (i64)2)) {
        ...
        if ((jcode == (i64)0)) {
            msysc$m_print_startfile(f);
            msysc$m_print_str((byte*)"<NO JHANDLER>",(byte*)"15jl");
            msysc$m_print_end();
            ;
        }
        else {
            msysc$m_print_startfile(f);
            msysc$m_print_setfmt((byte*)"#");
            msysc$m_print_str((pci_tables$jcodenames[(jcode)] + (i64)1),(byte*)"15jl");
            msysc$m_print_end();
            ;
        }
;
...
;
    msysc$m_print_startfile(f);
    msysc$m_print_str(pci_tables$typenames[((i64)(*p).mode)],(byte*)"6jl");
    msysc$m_print_end();
    ;
    msysc$m_print_startfile(f);
    msysc$m_print_i64((i64)(*p).memsize,NULL);
    msysc$m_print_space();
    msysc$m_print_end();
    ;
    if (!!((i64)(*p).mode2)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"<-",NULL);
        msysc$m_print_str(pci_tables$typenames[((i64)(*p).mode2)],(byte*)"6jl");
        msysc$m_print_end();
        ;
    }
;
...
if (($temp==(i64)2)) {
        d = (*q).def;
        name = (*d).name;
        if (((i64)(*d).idtype == (i64)3 || (i64)(*d).idtype == (i64)4)) {
            name = pci_lib$getbasename(name);
        }
;
        msysc$m_print_startfile(f);
        msysc$m_print_str(name,(byte*)"15jl");
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)4)) {
        msysc$m_print_startfile(f);
        msysc$m_print_i64((*q).value,(byte*)"15jl");
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)5)) {
        msysc$m_print_startfile(f);
        msysc$m_print_r64((*q).xvalue,(byte*)"15jl");
        msysc$m_print_end();
        ;
    }
    else if (($temp==(i64)3)) {
        ...
        msysc$m_print_setfmt((byte*)"## (#)");
        msysc$m_print_str((byte*)"#",NULL);
        msysc$m_print_i64((*q).labelno,NULL);
        msysc$m_print_i64((i64)pci_decls$labeltable[((*q).labelno)-1],NULL);
        msysc$m_print_end();
        ;
    }
        ...
        msysc$m_print_str((byte*)"\"",NULL);
        msysc$m_print_nogap();
        msysc$m_print_str((*q).svalue,NULL);
        msysc$m_print_nogap();
        msysc$m_print_str((byte*)"\"",NULL);
        msysc$m_print_end();
        ;
    ...
    msysc$m_print_end();
    ;
    if ((opcode==(i64)53) || (opcode==(i64)54) || (opcode==(i64)126) || (opcode==(i64)129) || (opcode==(i64)127) || (opcode==(i64)130) || (opcode==(i64)128) || (opcode==(i64)131)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Step:",NULL);
        msysc$m_print_i64((*p).x.step,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)56)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Min/max:",NULL);
        msysc$m_print_i64((i64)(*p).x.swmin,NULL);
        msysc$m_print_i64((i64)(*p).x.swmax,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)34) || (opcode==(i64)35)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Nargs/var:",NULL);
        msysc$m_print_i64((i64)(*p).x.nargs,NULL);
        msysc$m_print_i64((i64)(*p).x.nvars,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)1) || (opcode==(i64)41)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Nlocals/params/retvals:",NULL);
        msysc$m_print_i64((i64)(*p).x.nlocals,NULL);
        msysc$m_print_i64((i64)(*p).x.nparams,NULL);
        msysc$m_print_i64((i64)(*p).x.nretvalues,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)29) || (opcode==(i64)30) || (opcode==(i64)31) || (opcode==(i64)32) || (opcode==(i64)33) || (opcode==(i64)98) || (opcode==(i64)99)) {
        msysc$m_print_startfile(f);
        msysc$m_print_str((byte*)"Scale/offset:",NULL);
        msysc$m_print_i64((i64)(*p).x.scale,NULL);
        msysc$m_print_i64((i64)(*p).x.poffset,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)149)) {
        msysc$m_print_startfile(f);
        msysc$m_print_i64((i64)(*p).x.x,NULL);
        msysc$m_print_end();
        ;
    }
    else if ((opcode==(i64)40)) {
        if (!!((*q).def)) {
            ...
            msysc$m_print_str((*(*q).def).name,NULL);
            msysc$m_print_end();
            ;
        }
;
        ...
        if (((opcode >= (i64)45 && opcode <= (i64)50) && !!((i64)(*p).x.popone))) {
            msysc$m_print_startfile(f);
            msysc$m_print_str((byte*)"PopOne",NULL);
            msysc$m_print_end();
            ;
        }
;
...
void pci_support$loadlibs(void) {
    ...
    for (i=(i64)1;i<=pci_decls$nlibs;++i) {
L97 :;
        pci_decls$libinst[(i)-1] = mwindows$os_getdllinst(pci_decls$libnames[(i)-1]);
...
;
    ...
    for (i=(i64)1;i<=pci_decls$nlibs;++i) {
L100 :;
        fnaddr = (void (*)(void))mwindows$os_getdllprocaddr((i64)pci_decls$libinst[(i)-1],procname);
        if (!!(fnaddr)) {
            goto L102 ;
        }
;
