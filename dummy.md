...
63 to 2** 64-1          word64
  2
64 to 2** 127-1         int128
  2
127 to 2**128-1        word128
...
### Array Bounds
 Arrays normally are index from 1, but any lower bound can be used:
...
### Reference Parameters
 As showed above, '&' means a reference parameter, allowing a callee to modify data in the caller:
