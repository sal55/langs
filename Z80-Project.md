...
* Some instructions are fiddly to emulate but only took a small number of clock ticks in the original hardware. Others are easy but took lots of ticks. So emulation speed depends on the mix of instructions.
