...
export func bn_makefloat(real64 x)bignum =
    bignum a
    [2048]char str
...
!x   A4.B3 A3.B3 A2.B3 A1.B3 0   0
    ...
    int bx,cx       !indices within a,b,c
    int i,cx1, nc2
    bignum d
    ref elemtype c
    i64 pdquot,pdrem
...
func strvaln(ref char s,int n)int=    !STRVALN
...
export func bn_toint(bignum a)int64=
    int64 x
    if not bn_isint(a) then
        return 0
    fi
...
export func bn_tofloat(bignum a)real64=
    real64 x
    ichar s
