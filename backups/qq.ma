...
!CPL =PCLNEXT-PCLSTART

!CPL =NUNITS:"S,"
!CPL =UNITREC.BYTES
!CPL =NPCL:"S,"
!CPL =PCLNEXT-PCLSTART:"S,"
!
...
CPL =DISPATCHNAMES[DISPATCHTYPE]
CPL =FOPTIMISE
...
!TT:=CLOCK()-TT; PRINTLN "PARSE TIME=",TT; tt:=clock()
	for m in a..b do
		rx_module(modules[m])
	od
!TT:=CLOCK()-TT; PRINTLN "RX TIME=",TT; tt:=clock()
