...
!CPL INPUTFILES[1]
	...
	if inputfile=nil and not fwriteheaders then
		...
		println "    ",,sysparams[1],"-r prog[.c]          Compile prog.c and run"
		println "    ",,sysparams[1],"-i prog[.c]          Compile prog.c and interpret"
		println "    ",,sysparams[1],"-help                Show all options"
		stop 1
	fi
