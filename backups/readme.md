...
These ones were not generated by the mm/bb compiler, which would also have the modules needed for that particular configuration.

Instead, a mm7.pro/bb8.pro/etc file is maintained in each project folder which contains all relevant modules, also project files
