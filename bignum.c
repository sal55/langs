...
extern Bignum bn_init      (void);                           
extern Bignum bn_makestr   (char* s);                        
extern Bignum bn_makeint   (long long a);                    
extern Bignum bn_makefloat (double a);                       

extern int    bn_add       (Bignum c, Bignum a, Bignum b);   
extern int    bn_sub       (Bignum c, Bignum a, Bignum b);   

extern int    bn_mul       (Bignum c, Bignum a, Bignum b);   
extern int    bn_mulp      (Bignum c, Bignum a, Bignum b,    
                            int prec);
extern int    bn_div       (Bignum c, Bignum a, Bignum b,    
                            int prec);
extern int    bn_idiv      (Bignum c, Bignum a, Bignum b);   
extern int    bn_irem      (Bignum c, Bignum a, Bignum b);   
extern int    bn_idivrem   (Bignum c, Bignum r,
                            Bignum a, Bignum b);             

extern void   bn_negto     (Bignum a);                       
extern void   bn_absto     (Bignum a);                       

extern int    bn_ipower    (Bignum c, Bignum a, int n);      

extern int    bn_equal     (Bignum a, Bignum b);             
extern int    bn_cmp       (Bignum a, Bignum b);             

extern void   bn_free      (Bignum a);                       
extern void   bn_move      (Bignum c, Bignum a);             
extern void   bn_dupl      (Bignum c, Bignum a);             

extern void   bn_setzero   (Bignum c);                       
extern void   bn_setinf    (Bignum c);                       
extern void   bn_setnan    (Bignum c);                       

extern Bignum bn_const     (long long n);                    

extern int    bn_iszero    (Bignum a);                       
extern int    bn_isint     (Bignum a);                       
extern int    bn_isinf     (Bignum a);                       
extern int    bn_isnan     (Bignum a);                       

extern int    bn_getprec   (Bignum a);                       
extern int    bn_getglobalprec (void);                       

extern void   bn_setprec   (Bignum a, int n);                
extern void   bn_setglobalprec       (int n);                

extern int    bn_sign      (Bignum a);                       
extern int    bn_digits    (Bignum a);                       

extern void   bn_fix       (Bignum c, Bignum a);             

extern long long int
              bn_toint     (Bignum a);                       
extern double bn_tofloat   (Bignum a);                       

extern char*  bn_tostring  (Bignum a, int fmt);              
extern void   bn_print     (Bignum a);                       
extern void   bn_println   (Bignum a);                       
...
enum {maxprec       = 1000000};          
static int currprec = 100/digitwidth;    

static int stblz;                        

static constrec* constlist = NULL;       
