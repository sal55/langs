importdll $dummy =
    ...
    func "SDL_CreateWindow"                  (ichar,i32,i32,i32,i32,u32)ref SDL_Window
    ...
    record SDL_VirtualJoystickDesc = $caligned
        u16 version
        u16 type$
        u16 naxes
        u16 nbuttons
...
!    const SDL_SYSWMEVENT                     = 513
    ...
    const SDL_SENSORUPDATE2                   = 4608
    const SDL_RENDER_TARGETS_RESET2           = 8192
...
!    const SDL_USEREVENT                      = 32768
    ...
    record SDL_TextEditingExtEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        ref i8 text
    ...
    record SDL_JoyBatteryEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        i32 level
    ...
    record SDL_hid_device_ = $caligned
        int dummy    !empty record
    end

    record SDL_hid_device_info = $caligned
        ref i8 path
        u16 vendor_id
        u16 product_id
