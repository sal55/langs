...
# Go, Lua, Python, Ruby, C, Julia, Rust, D, Nim, Algol68, Odin, Zig

# Lua and probably Ruby versions are original Shootout code. The M version seems to derived from the Lua,
# the rest are ported from the M code so as to use the same algorithm

# ***********************************************************************************************
# M Language giving the reference algorithm. (Which I now realise was derived from the Lua version
# on the Shootout site. Most other versions will be based on this one.)
# ***********************************************************************************************
...
# ***********************************************************************************************
# Q version (my scripting language)
# ***********************************************************************************************
...
# ***********************************************************************************************
# Lua Version - I think this is the original one from which the others are derived
# ***********************************************************************************************
