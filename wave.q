...
!add note to wave data w
!freq is frequency in hz
!length is duration in milliseconds
!volume is intensity from 0.0 to 1.0
!need to add so many sequences of n 255*volume bytes followed by n 0 bytes,
!depending on those parameters


!If w.freq is 10KHz, and freq is 500Hz, then that's 20 samples per note cycle,
!or 10 high and 10 low segment. It'll be square wave modulated for now.
!
