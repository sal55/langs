importdll $test =
    ...
    record SDL_AssertData = $caligned
        i32 always_ignore
        u32 trigger_count
        ref i8 condition
        ref i8 filename
    ...
    func "SDL_ReadU8"                        (ref SDL_RWops)byte
    ...
    func "SDL_WriteU8"                       (ref SDL_RWops,byte)u64
    ...
    func "SDL_LoadWAV_RW"                    (ref SDL_RWops,i32,ref SDL_AudioSpec,ref ref byte,ref u32)ref SDL_AudioSpec
    proc "SDL_FreeWAV"                       (ref byte)
    func "SDL_BuildAudioCVT"                 (ref SDL_AudioCVT,u16,byte,i32,u16,byte,i32)i32
    func "SDL_ConvertAudio"                  (ref SDL_AudioCVT)i32
    record _SDL_AudioStream = $caligned
        int dummy    !empty record
    end

    func "SDL_NewAudioStream"                (u16,byte,i32,u16,byte,i32)ref _SDL_AudioStream
    ...
    proc "SDL_MixAudio"                      (ref byte,ref byte,u32,i32)
    proc "SDL_MixAudioFormat"                (ref byte,ref byte,u16,u32,i32)
    ...
    record SDL_PixelFormat = $caligned
        u32 format
    ...
    func "SDL_MapRGB"                        (ref SDL_PixelFormat,byte,byte,byte)u32
    func "SDL_MapRGBA"                       (ref SDL_PixelFormat,byte,byte,byte,byte)u32
    proc "SDL_GetRGB"                        (u32,ref SDL_PixelFormat,ref byte,ref byte,ref byte)
    proc "SDL_GetRGBA"                       (u32,ref SDL_PixelFormat,ref byte,ref byte,ref byte,ref byte)
    proc "SDL_CalculateGammaRamp"            (r32,ref u16)
    record SDL_Point = $caligned
        i32 x
        i32 y
    end

    record SDL_FPoint = $caligned
        r32 x
        r32 y
    end

    record SDL_Rect = $caligned
        i32 x
        i32 y
        i32 w
        i32 h
    ...
    func "SDL_SetSurfaceColorMod"            (ref SDL_Surface,byte,byte,byte)i32
    func "SDL_GetSurfaceColorMod"            (ref SDL_Surface,ref byte,ref byte,ref byte)i32
    func "SDL_SetSurfaceAlphaMod"            (ref SDL_Surface,byte)i32
    func "SDL_GetSurfaceAlphaMod"            (ref SDL_Surface,ref byte)i32
    ...
    func "SDL_GetKeyboardState"              (ref i32)ref byte
    ...
    func "SDL_CreateCursor"                  (ref byte,ref byte,i32,i32,i32,i32)ref SDL_Cursor
    ...
    func "SDL_JoystickGetDeviceGUID"         (i32)$T9
    ...
    func "SDL_JoystickSetVirtualButton"      (ref _SDL_Joystick,i32,byte)i32
    func "SDL_JoystickSetVirtualHat"         (ref _SDL_Joystick,i32,byte)i32
    ...
    func "SDL_JoystickGetGUID"               (ref _SDL_Joystick)$T9
    ...
    func "SDL_JoystickGetGUIDFromString"     (ref i8)$T9
    ...
    func "SDL_JoystickGetHat"                (ref _SDL_Joystick,i32)byte
    func "SDL_JoystickGetBall"               (ref _SDL_Joystick,i32,ref i32,ref i32)i32
    func "SDL_JoystickGetButton"             (ref _SDL_Joystick,i32)byte
    ...
    func "SDL_JoystickSetLED"                (ref _SDL_Joystick,byte,byte,byte)i32
    ...
    record _SDL_GameController = $caligned
        int dummy    !empty record
    end
    ...
    record SDL_GameControllerButtonBind = $caligned
        i32 bindType
        $T10 value
    end
    ...
    func "SDL_GameControllerGetBindForAxis"  (ref _SDL_GameController,i32)SDL_GameControllerButtonBind
    ...
    func "SDL_GameControllerGetBindForButton" (ref _SDL_GameController,i32)SDL_GameControllerButtonBind
    func "SDL_GameControllerHasButton"       (ref _SDL_GameController,i32)i32
    func "SDL_GameControllerGetButton"       (ref _SDL_GameController,i32)byte
    ...
    func "SDL_GameControllerGetTouchpadFinger" (ref _SDL_GameController,i32,i32,ref byte,ref r32,ref r32,ref r32)i32
    ...
    func "SDL_GameControllerSetLED"          (ref _SDL_GameController,byte,byte,byte)i32
    ...
    record SDL_CommonEvent = $caligned
        u32 type$
        u32 timestamp
    end

    record SDL_DisplayEvent = $caligned
        u32 type$
        u32 timestamp
        u32 display
        byte event
    ...
    record SDL_WindowEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        byte event
    ...
    record SDL_KeyboardEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        byte state
    ...
    record SDL_TextEditingEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        [32]i8 text
    ...
    record SDL_TextInputEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        [32]i8 text
    ...
    record SDL_MouseMotionEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        u32 which
    ...
    record SDL_MouseButtonEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        u32 which
    ...
    record SDL_MouseWheelEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        u32 which
    ...
    record SDL_JoyAxisEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte axis
    ...
    record SDL_JoyBallEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte ball
    ...
    record SDL_JoyHatEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte hat
    ...
    record SDL_JoyButtonEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte button
    ...
    record SDL_JoyDeviceEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
    end

    record SDL_ControllerAxisEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte axis
    ...
    record SDL_ControllerButtonEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        byte button
    ...
    record SDL_ControllerDeviceEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
    end

    record SDL_ControllerTouchpadEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        i32 touchpad
    ...
    record SDL_ControllerSensorEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        i32 sensor
    ...
    record SDL_AudioDeviceEvent = $caligned
        u32 type$
        u32 timestamp
        u32 which
        byte iscapture
    ...
    record SDL_TouchFingerEvent = $caligned
        u32 type$
        u32 timestamp
        i64 touchId
        i64 fingerId
    ...
    record SDL_MultiGestureEvent = $caligned
        u32 type$
        u32 timestamp
        i64 touchId
        r32 dTheta
    ...
    record SDL_DollarGestureEvent = $caligned
        u32 type$
        u32 timestamp
        i64 touchId
        i64 gestureId
    ...
    record SDL_SensorEvent = $caligned
        u32 type$
        u32 timestamp
        i32 which
        [6]r32 data
    ...
    record SDL_QuitEvent = $caligned
        u32 type$
        u32 timestamp
    end

    record SDL_OSEvent = $caligned
        u32 type$
        u32 timestamp
    end

    record SDL_UserEvent = $caligned
        u32 type$
        u32 timestamp
        u32 windowID
        i32 code
    ...
    record SDL_SysWMmsg = $caligned
        int dummy    !empty record
    end

    record SDL_SysWMEvent = $caligned
        u32 type$
        u32 timestamp
        ref SDL_SysWMmsg msg
    end

    record SDL_Event = $caligned
        u32 type$
    ...
    func "SDL_EventState"                    (u32,i32)byte
    func "SDL_RegisterEvents"                (i32)u32
    func "SDL_GetBasePath"                   ()ref i8
    func "SDL_GetPrefPath"                   (ref i8,ref i8)ref i8
    record _SDL_Haptic = $caligned
        int dummy    !empty record
    end

    record SDL_HapticDirection = $caligned
        byte type$
        [3]i32 dir
    end

    record SDL_HapticConstant = $caligned
        u16 type$
    ...
    record SDL_HapticPeriodic = $caligned
        u16 type$
        SDL_HapticDirection direction
        u32 length
        u16 delay
    ...
    record SDL_HapticCondition = $caligned
        u16 type$
        SDL_HapticDirection direction
        u32 length
        u16 delay
    ...
    record SDL_HapticRamp = $caligned
        u16 type$
        SDL_HapticDirection direction
        u32 length
        u16 delay
    ...
    record SDL_HapticLeftRight = $caligned
        u16 type$
        u32 length
        u16 large_magnitude
        u16 small_magnitude
    ...
    record SDL_HapticCustom = $caligned
        u16 type$
        SDL_HapticDirection direction
        u32 length
        u16 delay
    ...
    record SDL_HapticEffect = $caligned
        u16 type$
    ...
    record SDL_RendererInfo = $caligned
        ref i8 name
        u32 flags
    ...
    record SDL_Renderer = $caligned
        int dummy    !empty record
    end

    record SDL_Texture = $caligned
        int dummy    !empty record
    end
    ...
    func "SDL_SetTextureColorMod"            (ref SDL_Texture,byte,byte,byte)i32
    func "SDL_GetTextureColorMod"            (ref SDL_Texture,ref byte,ref byte,ref byte)i32
    func "SDL_SetTextureAlphaMod"            (ref SDL_Texture,byte)i32
    func "SDL_GetTextureAlphaMod"            (ref SDL_Texture,ref byte)i32
    ...
    func "SDL_UpdateYUVTexture"              (ref SDL_Texture,ref SDL_Rect,ref byte,i32,ref byte,i32,ref byte,i32)i32
    func "SDL_UpdateNVTexture"               (ref SDL_Texture,ref SDL_Rect,ref byte,i32,ref byte,i32)i32
    ...
    func "SDL_SetRenderDrawColor"            (ref SDL_Renderer,byte,byte,byte,byte)i32
    func "SDL_GetRenderDrawColor"            (ref SDL_Renderer,ref byte,ref byte,ref byte,ref byte)i32
    ...
    record $T16 = $caligned
        byte binarizationCutoff
        SDL_Color colorKey
    end

    record SDL_WindowShapeMode = $caligned
        i32 mode
        $T16 parameters
    end
...
global const SDL_ASSEMBLY_ROUTINES = 1
...
global macro  SDL_CreateThreadWithStackSize(fn,name,stacksize,data) = SDL_CreateThreadWithStackSize(fn,name,data,(pfnSDL_CurrentBeginThread)_beginthreadex,(pfnSDL_CurrentEndThread)SDL_endthread)
...
global macro  SDL_VERSION_ATLEAST(X,Y,Z) = (SDL_COMPILEDVERSION>=SDL_VERSIONNUM(X,Y,Z))
...
global const SDL_PATCHLEVEL = 16
