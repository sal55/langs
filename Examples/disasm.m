!x64 subset disassembler
!decodeinstr() turns one instruction into ASM source

!const showmregs=1       # Use my own register designations
const showmregs=0        # Use Intel names
