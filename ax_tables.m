...
!("$" is device to pick up the name of the last enum; saves having enter lots of strings)
! "!" introduces a comment to eol
! tabledata(), with "()", defines enum as the first column ((...) has an optional
!   type name, never used)
! tabledata, with no "()", has no enumns; all the columns are parallel arrays
