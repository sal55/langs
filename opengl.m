importdll opengl32 =
    ...
    clang function "glAreTexturesResident"             (i32,ref u32,ref byte)byte
    ...
    clang function "glGenLists"                        (i32)u32
    ...
    clang function "glGetString"                       (u32)ref byte
    ...
    clang function "glIsEnabled"                       (u32)byte
    clang function "glIsList"                          (u32)byte
    clang function "glIsTexture"                       (u32)byte
    ...
    clang function "glRenderMode"                      (u32)i32
    ...
    clang function "gluErrorString"                    (u32)ref byte
    clang function "gluErrorUnicodeStringEXT"          (u32)ref u16
    clang function "gluGetString"                      (u32)ref byte
    ...
    clang function "gluProject"                        (r64,r64,r64,ref r64,ref r64,ref i32,ref r64,ref r64,ref r64)i32
    clang function "gluUnProject"                      (r64,r64,r64,ref r64,ref r64,ref i32,ref r64,ref r64,ref r64)i32
    clang function "gluScaleImage"                     (u32,i32,i32,u32,ref void,i32,i32,u32,ref void)i32
    ...
    clang function "gluNewTess"                        ()ref GLUtesselator
    ...
    clang function "gluNewNurbsRenderer"               ()ref GLUnurbs
    ...
    clang function "glutCreateWindow"                  (ref char)i32
    clang function "__glutCreateWindowWithExit"        (ref byte,ref clang proc(i32))i32
    clang function "glutCreateWindow_ATEXIT_HACK"      (ref byte)i32
    clang function "glutCreateSubWindow"               (i32,i32,i32,i32,i32)i32
    ...
    clang function "glutGetWindow"                     ()i32
    ...
    clang function "glutCreateMenu"                    (ref clang proc(i32))i32
    clang function "__glutCreateMenuWithExit"          (ref clang proc(i32),ref clang proc(i32))i32
    clang function "glutCreateMenu_ATEXIT_HACK"        (ref clang proc(i32))i32
    clang proc     "glutDestroyMenu"                   (i32)
    clang function "glutGetMenu"                       ()i32
    ...
    clang function "glutGetColor"                      (i32,i32)r32
    clang proc     "glutCopyColormap"                  (i32)
    clang function "glutGet"                           (u32)i32
    clang function "glutDeviceGet"                     (u32)i32
    clang function "glutExtensionSupported"            (ref byte)i32
    clang function "glutGetModifiers"                  ()i32
    clang function "glutLayerGet"                      (u32)i32
    clang proc     "glutBitmapCharacter"               (ref void,i32)
    clang function "glutBitmapWidth"                   (ref void,i32)i32
    clang proc     "glutStrokeCharacter"               (ref void,i32)
    clang function "glutStrokeWidth"                   (ref void,i32)i32
    clang function "glutBitmapLength"                  (ref void,ref byte)i32
    clang function "glutStrokeLength"                  (ref void,ref byte)i32
    ...
    clang function "glutVideoResizeGet"                (u32)i32
    ...
    clang function "glutEnterGameMode"                 ()i32
    clang proc     "glutLeaveGameMode"                 ()
    clang function "glutGameModeGet"                   (u32)i32
