...
OBJ           Object files are generated by first writing ASM then invoking AA to produce OBJ format. The single OBJ file
              produced represents the whole program. OBJ files allowed M code to be statically linked with other languages,
              but require an external linker.
