...
global tabledata() [0:]ichar stdtypenames, [0:]byte stdtypewidths,
		 ...
		 [0:]byte stdtopcl =
	(tnone=0,		"none",		0,	0,	0,		0,		"",			0),		!error or not set or not used
	(tvoid,			"void",		0,	0,	0,		0,		"void",		tpvoid),

	(tschar,		"schar",	8,	1,	tsint,	'I',	"i8",		tpi8),		! This ordering is important
	(tsshort,		"short",	16,	1,	tsint,	'I',	"i16",		tpi16),	!
	(tsint,			"int",		32,	1,	0,		'I',	"i32",		tpi32),	!
	(tsllong,		"llong",	64,	1,	0,		'I',	"i64",		tpi64),	!

	(tbool,			"bool",		8,	0,	tuint,	'U',	"byte",		tpu8),		! As is this
	(tuchar,		"uchar",	8,	0,	tuint,	'U',	"byte",		tpu8),		!
	(tushort,		"ushort",	16,	0,	tuint,	'U',	"u16",		tpu16),	!
	(tuint,			"uint",		32,	0,	0,		'U',	"u32",		tpu32),	!
	(tullong,		"ullong",	64,	0,	0,		'U',	"u64",		tpi64),	!

	(tfloat,		"float",	32,	0,	0,		'R',	"r32",		tpr32),	! And tfloat must be >= integer types
	(tdouble,		"double",	64,	0,	0,		'R',	"r64",		tpr64),	!
	(tldouble,		"ldouble",	128,0,	0,		'R',	"r64",		tpr64),	!

	(tcomplex,		"complex",	128,0,	0,		0,		"",			tpvoid),	!

	(tenum,			"enum",		0,	0,	0,		0,		"",			tpvoid),		!
	(tref,			"ref",		64,	0,	0,		0,		"",			tpu64),	! 
	(tproc,			"proc",		64,	0,	0,		0,		"",			tpu64),	!
	(tlabel,		"label",	64,	0,	0,		0,		"",			tpu64),	!

	(tarray,		"array",	0,	0,	0,		0,		"",			tpblock),		!
	(tstruct,		"struct",	0,	0,	0,		0,		"",			tpblock),		!
	(tunion,		"union",	0,	0,	0,		0,		"",			tpblock),		!
